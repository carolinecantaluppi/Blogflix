        ...
        <div class="col-lg-4 col-md-12 mb-4">
          <div class="card rounded shadow-sm border-0">
            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
              <img src="{{Storage::url($movie['img'])}}" class="img-fluid" alt="..." width="100%" height="300"> 
              <a href="#!">
            ...
            <div class="card-body">
              ...
              <a href="{{route('moviedetail', ['key'=>$loop->index])}}" class="btn btn-sm btn-dark justify-content-center">Leggi</a>
            </div>      
          </div>
        </div>
        @empty
  ...
  <main class="my-5">
    <div class="container">
      ...
      <section class="text-center">
        <h4 class="mb-5"><strong>Ultimi posts</strong></h4>
